...
export const flows: SystemFlow[] = [
  ...
  },
  {
    ...
    edges: [
      { d: 'M 60 174 L 134 174' },
      { d: 'M 180 174 L 254 174' },
      { d: 'M 295 174 L 344 174' },
      { d: 'M 800 174 L 726 174' },
      { d: 'M 680 174 L 606 174' },
      { d: 'M 565 174 L 516 174' },
    ],
    steps: [
      {
        node: 'infra',
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        id: 'svcPay',
        label: { es: 'Servicio pagos', en: 'Payments service' },
        icon: 'lucide:credit-card',
        x: 490,
        y: 56,
        w: 150,
      ...
      {
        id: 'svcUsers',
        label: { es: 'Servicio usuarios', en: 'Users service' },
        icon: 'lucide:users',
        x: 490,
        y: 220,
        w: 150,
